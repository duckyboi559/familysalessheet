...
function currentBuilderCategory() {
if (currentMode === "pancakes") return "pancakes";
if (currentMode === "lemonade") return "lemonade";
if (currentMode === "hotdogs") return "hotdogs";
return orderTab;
}
...
return (order.items || []).filter(i => i.station === currentMode);
}
